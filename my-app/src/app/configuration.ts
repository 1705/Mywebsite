export const configuration = {
  ...
  intro: {
    ...
    features: [
      { icon: 'html5 &amp; CSS3', title: 'HTML5', description: 'Has ne tritani atomorum conclusionemque, in dolorum volumus cotidieque eum. At vis choro neglegentur iudico' },
  ...
  footer: {
    ...
    developer: 'VAISHALI STUDIO',
    developerlink: 'http://vaishali.in',
  },
  socialsites: [
    { link: 'https://www.facebook.com/', target: '_blank', title: 'Facebook', username: 'vaishali', icon: 'facebook' },
    { link: 'http://google.com/+', target: '_blank', title: 'Google+', username: 'vaishali', icon: 'google-plus' },
    { link: 'http://www.twitter.com/', target: '_blank', title: 'Twitter', username: 'vaishali', icon: 'twitter' },
    { link: 'http://www.instagram.com/', target: '_blank', title: 'Instagram', username: 'vaishali', icon: 'instagram' },
    { link: 'http://www.behance.net', target: '_blank', title: 'behance', username: 'vaishali', icon: 'behance' },
  ],
  blog: {
    tagline: 'MY BLOG',
    title: 'Thoughts become things...',
    posts: [
      { id: 1, title: 'The first Article', author: 'AD', image: 'gallery-image-1.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 2, title: 'The second Article', author: 'AD', image: 'gallery-image-2.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 3, title: 'The third Article', author: 'AD', image: 'gallery-image-3.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 4, title: 'The fourth Article', author: 'AD', image: 'gallery-image-4.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 5, title: 'The fifth Article', author: 'AD', image: 'gallery-image-5.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 6, title: 'The sixth Article', author: 'AD', image: 'gallery-image-6.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 7, title: 'The seven Article', author: 'AD', image: 'gallery-image-1.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 8, title: 'The eight Article', author: 'AD', image: 'gallery-image-3.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 9, title: 'The nine Article', author: 'AD', image: 'gallery-image-5.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 10, title: 'The ten Article', author: 'AD', image: 'gallery-image-2.jpg', publishdate: '2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
      { id: 11, title: 'The eleven Article', author: 'AD', image: 'gallery-image-6.jpg', publishdate:'2018-12-23T07:16:00.000Z', excert: 'This is the summary of the article....' },
    ]
  }
};
